...
BufferGPU::BufferGPU(const Device& device, const AdhocQueues& adhoc_queues, VkDeviceSize size, VkBufferUsageFlags usage) :
...
{
    m_adhoc_queues->transfer().run([&](VkCommandBuffer command_buffer) {
